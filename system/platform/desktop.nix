...
with import ../prelude args; {
  ...
  services = {
    ...
    xserver = {
      ...
      xkb = let
        inNeoFamily = layout:
          (elem layout [ "bone" "adnw" ]) || (hasPrefix "neo" layout);
      in ({
        options = "";
  ...
  environment = {
    systemPackages = unite [
      (with pkgs; [
        ...
        [ cfg.xorg [ xorg.xauth rofi flameshot ] ]
        [
          cfg.multimedia
          [
            # video
  ...
  programs = {
    ...
    firefox = {
      ...
      policies = let
        ...
        rustIcon =
          "https://doc.rust-lang.org/static.files/favicon-32x32-422f7d1d52889060.png";
        ...
        blenderIcon =
          "https://docs.blender.org/manual/en/latest/_static/favicon.png";
        steamdbIcon =
          "https://steamdb.info/static/logos/vector_prefers_schema.svg";
      ...
      in {
        ...
        Bookmarks = mapAttrsToList (name: url: {
          Title = name;
          URL = url;
          Favicon = if hasPrefix "Nix" name then
            nixIcon
        ...
        SearchEngines = {
          ...
          Add = [
            ...
            }
            {
              ...
              Alias = "@archdoc";
              URLTemplate =
                "https://wiki.archlinux.org/index.php?search={searchTerms}&title=Special%3ASearch";
              Method = "GET";
              IconURL = archIcon;
            }
            {
              ...
              Alias = "@pydoc";
              URLTemplate =
                "https://docs.python.org/3/search.html?q={searchTerms}";
              Method = "GET";
              IconURL = pythonIcon;
            }
            {
            ...
            }
            {
              ...
              Alias = "@rsext";
              URLTemplate =
                "https://docs.rs/releases/search?query={searchTerms}&sort=recent-downloads";
              Method = "GET";
              IconURL = docsrsIcon;
            }
            {
            ...
            }
            {
              ...
              Alias = "@nixdoc";
              URLTemplate =
                "https://nixos.wiki/index.php?search={searchTerms}&go=Go";
              Method = "GET";
              IconURL = nixIcon;
            }
            {
            ...
            }
            {
              ...
              Alias = "@steamdb";
              URLTemplate =
                "https://steamdb.info/search/?a=all&q={searchTerms}";
              Method = "GET";
              IconURL = steamdbIcon;
            }
            {
              ...
              Alias = "@blender";
              URLTemplate =
                "https://docs.blender.org/manual/en/latest/search.html?q={searchTerms}&check_keywords=yes&area=default";
              Method = "GET";
              IconURL = blenderIcon;
            }
            {
              ...
              Alias = "@wikipedia";
              URLTemplate =
                "https://en.wikipedia.org/wiki/Special:Search?go=Go&search={searchTerms}";
              Method = "GET";
            ...
            }
            {
              ...
              Alias = "@wd";
              URLTemplate =
                "https://www.wikidata.org/w/index.php?go=Go&search={searchTerms}";
              Method = "GET";
      ...
      preferences = concatMapAttrs (prefix:
        mapKv (key: if prefix == "" then key else "${prefix}.${key}") id) {
  ...
  environment.etc."thunderbird/policies/policies.json".source = let
    json = (pkgs.formats.json { }).generate "thunderbird-policies.json";
    preferences = mapKv (key: "intl.date_time.pattern_override.${key}")
      (value: {
        Value = value;
        Status = "locked";
      });
